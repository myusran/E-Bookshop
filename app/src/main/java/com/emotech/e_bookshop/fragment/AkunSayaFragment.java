...
import com.emotech.e_bookshop.adapter.CustomAkunSaya;
...
public class AkunSayaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tabLayout = (TabLayout)view.findViewById(R.id.akunSayatabs);
        viewPager = (ViewPager)view.findViewById(R.id.akusayaview_pager);

        viewPager.setAdapter(new CustomAkunSaya(getChildFragmentManager()));
